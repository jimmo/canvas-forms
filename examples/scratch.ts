...
const l = f.add(new candle.Label('the pixel ratio is ' + window.devicePixelRatio), 10, 10);
...
new candle.AlignConstraint(bfx1, candle.Coord.XW, bfx2, candle.Coord.X, -20);
